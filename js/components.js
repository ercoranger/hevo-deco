var app = new Vue({
    ...
    data: {
        ...
        navbar: '<div class="navbar container"><ul class="nav"><li class="nav-item"><a class="nav-link active" href="../index.html">Home | 最新消息</a></li><li class="nav-item"><a class="nav-link" href="/products">Product | 產品</a></li><li class="nav-item"><a class="nav-link" href="/shopInfo">Shop | 商店</a></li><li class="nav-item"><a class="nav-link" href="/about">About | 關於百鐵</a></li></ul></div>',
        //導覽列
